...
/**
 * MODELO 2: X DIAS QUE NÃO ENTRA (Reengajamento por Inatividade)
 */
...
/**
 * MODELO 3: RECUPERAÇÃO DE SENHA (Password Reset)
 */
...
/**
 * MODELO 4: LEMBRETE PARA ESTUDAR (Lembrete de Constância)
 */
