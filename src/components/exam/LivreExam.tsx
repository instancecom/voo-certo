        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <div className="flex items-center gap-3">
              <div>
                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest leading-none">MODO LIVRE</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-4">
            ...
            {currentQuestionIndex === shuffledQuestions.length - 1 ? (
              <Button
                onClick={() => setShowFinishDialog(true)}
                className="h-11 px-6 rounded-[6px] font-bold text-xs uppercase tracking-wider gap-2 bg-accent hover:bg-accent/90 text-accent-foreground shadow-md"
              >
                <span>Finalizar</span>
