...
import { BarChart3, Clock, Target, TrendingUp, Award, Calendar, ArrowRight, Lock, Loader2 } from 'lucide-react';
...
export default function ProgressPage() {
  ...
  const resultsByCategory = userResults.reduce((acc, result) => {
    ...
    if (!acc[exam.subcategory_id]) {
      acc[exam.subcategory_id] = [];
    }
            ...
            <>
              ...
              >
                ...
                <div className="p-6 rounded-2xl bg-card border border-border">
                  ...
                  <div className="text-3xl font-bold text-success">+{Math.min(averageScore, 12)}%</div>
                </div>
              </motion.div>
